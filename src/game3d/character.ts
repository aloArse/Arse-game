...
export const POSES: Record<string, Pose> = {
  ...
  fly: {
    ...
    shL: [-2.88, 0.14, 0.14], elL: [-0.07, 0, 0], wrL: [-0.1, 0, 0],
    shR: [-2.88, -0.14, -0.14], elR: [-0.07, 0, 0], wrR: [-0.1, 0, 0],
  ...
  fist: {
    ...
    shL: [0.46, 0.12, 0.22], elL: [-0.34, 0, 0.05], wrL: [-0.2, 0, 0],
    shR: [-2.96, -0.1, -0.12], elR: [-0.04, 0, 0], wrR: [-0.12, 0, 0],
    hipL: [0.17, 0, 0.06], kneeL: [0.19, 0, 0], ankL: [-0.2, 0, 0],
    hipR: [0.07, 0, -0.06], kneeR: [0.09, 0, 0], ankR: [-0.1, 0, 0],
  },
  dash: {
    spine: [0.09, 0, 0], chest: [0.02, 0, 0], neck: [-0.14, 0, 0], head: [-0.18, 0, 0],
    shL: [0.58, 0.04, 0.12], elL: [-0.54, 0, 0.04], wrL: [-0.16, 0, 0],
    shR: [0.58, -0.04, -0.12], elR: [-0.54, 0, -0.04], wrR: [-0.16, 0, 0],
    hipL: [0.05, 0, 0.04], kneeL: [0.07, 0, 0], ankL: [-0.1, 0, 0],
    hipR: [0.05, 0, -0.04], kneeR: [0.07, 0, 0], ankR: [-0.1, 0, 0],
  },
  ...
  grab: {
    ...
    shL: [-1.72, 0.26, 0.2], elL: [-0.34, 0, 0], wrL: [-0.3, 0, 0],
    shR: [-1.72, -0.26, -0.2], elR: [-0.34, 0, 0], wrR: [-0.3, 0, 0],
  ...
  slamUp: {
    ...
    shL: [-2.96, 0.22, 0.36], elL: [-0.28, 0, 0], wrL: [-0.2, 0, 0],
    shR: [-2.96, -0.22, -0.36], elR: [-0.28, 0, 0], wrR: [-0.2, 0, 0],
  ...
  slamDown: {
    ...
    shL: [-0.4, 0.12, 0.16], elL: [-0.2, 0, 0], wrL: [-0.3, 0, 0],
    shR: [-0.4, -0.12, -0.16], elR: [-0.2, 0, 0], wrR: [-0.3, 0, 0],
    hipL: [0.48, 0, 0.2], kneeL: [0.6, 0, 0], ankL: [-0.4, 0, 0],
    hipR: [0.48, 0, -0.2], kneeR: [0.6, 0, 0], ankR: [-0.4, 0, 0],
  },
  spin: {
    spine: [0.02, 0, 0], chest: [0, 0, 0], neck: [0, 0, 0], head: [0.04, 0, 0],
    shL: [-1.52, 0.1, 1.18], elL: [-0.12, 0, 0], wrL: [-0.3, 0, 0],
    shR: [-1.52, -0.1, -1.18], elR: [-0.12, 0, 0], wrR: [-0.3, 0, 0],
    hipL: [0.18, 0, 0.14], kneeL: [0.5, 0, 0], ankL: [-0.4, 0, 0],
    hipR: [0.28, 0, -0.14], kneeR: [0.66, 0, 0], ankR: [-0.4, 0, 0],
  },
  block: {
